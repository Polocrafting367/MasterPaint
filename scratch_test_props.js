...
fs.writeFileSync('./scratch_worker_mod6.js', workerCode);

import('./scratch_worker_mod6.js').then(async () => {
    setTimeout(async () => {
        const lr = new global.LibRawClass();
        console.log("Prototype properties:");
        console.log(Object.getOwnPropertyNames(Object.getPrototypeOf(lr)));
    }, 1000);
}).catch(console.error);
