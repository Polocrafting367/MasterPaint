...
### [Essayer MasterPaint : polocrafting.fr/Illu](http://polocrafting.fr/Illu)
...
**aucune publicité, aucun système de traçage, et traitement 100% local.**
...
Puisque le projet n'utilise aucun script côté serveur, vous pouvez simplement cloner ce dépôt et exécuter le projet en quelques clic, j'utilise perso XAMPP mais nimporte quel hebergeurweb local fonctionnera 
