...
**Portage de PaintDotNet sur Linux, MacOS, Android et meme IOS via html avec l'ia.**
...
### -> [Essayez ici : polocrafting.fr/Illu](http://polocrafting.fr/Illu)
...
**Aucun tracking, pas de publicité, tout tourne en local, tout reste sur votre machine !**
...
L'application est hébergée, disponible :
-> **[http://polocrafting.fr/Illu](http://polocrafting.fr/Illu)**

### 2. En local sur votre machine
j'utilise xampp pour le lancer en un clic, mais nomporte quel hébergement web local fonctionne aussi
